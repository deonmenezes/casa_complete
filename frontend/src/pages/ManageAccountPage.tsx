...
const ManageAccountPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // const response = await fetch(`http://casa-backend-uf0h.onrender.com/api/users/${userId}`, {
      //   method: 'PUT',
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const response = await fetch('http://casa-backend-uf0h.onrender.com/api/users/delete-by-phone', {
        method: 'DELETE',
        headers: {
